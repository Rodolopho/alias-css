export default {
    'css-global-values':['initial:ini','inherit:in','unset:un', 'revert:re','revert-layer:rl'],
    style:['dotted:d','dashed:da','solid:s','double:db','groove:g','ridge:ri','inset:i','outset:o','none:n','hidden:h'],
